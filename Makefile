...
# $(eval REV=$(shell git rev-parse HEAD | cut -c1-7))
	docker tag centos-repo 240979667302.dkr.ecr.ap-southeast-2.amazonaws.com/testqube:latest
...
docker-push:
#$(eval REV=$(shell git rev-parse HEAD | cut -c1-7))
	docker push 240979667302.dkr.ecr.ap-southeast-2.amazonaws.com/testqube:latest
